...
row_skip = [24]
df = pd.read_excel('6 sown area -Rabi -2018-19.xls', 'rabi 2018-19 (4)',skiprows=row_skip)

# Deleting the last two columns of data
...
# Export to csv file
df_all.to_csv('jayashankar_rabi_2018-19.csv', index=False)
